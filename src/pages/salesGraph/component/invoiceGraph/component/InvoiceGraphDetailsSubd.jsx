...
export default function InvoiceGraphDetailsSudb({ startingYear, endingYear }) {
  ...
  const fetchYearWiseData = async (year) => {
    const res = await axios.get(
      `${process.env.REACT_APP_URL}/api/getMonthlyEntities?EntityType=SUBD&BillCode=INVS&BillYear=${year}`,
      {
        headers: {
