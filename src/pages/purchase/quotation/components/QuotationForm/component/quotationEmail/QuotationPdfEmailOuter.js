...
// export default function quotationPdfEmail(
//   data,
//   emailFormData,
//   emailMszFn,
//   onPopupMessage // Renamed to a generic callback
// ) {
...
//       if (!isValidEmail(emailFormData.to)) {
//         if (onPopupMessage)
//           onPopupMessage("The 'to' field must be a valid email address.");
...
//       formData.append("body", "<h1> {emailFormData.body}</h1>"); // Use the emailFormData body field
//       // emailMszFn(false);

//       // Make a POST request to upload the PDF using axios
//       axios
//         .post(`${process.env.REACT_APP_URL}/api/sendMailPdf`, formData, {
//           headers: {
...
//           emailMszFn(true); // Call the emailMszFn with the response data
//           if (onPopupMessage) onPopupMessage("Email sent successfully!"); // Trigger popup message
//         })
//         .catch((error) => {
//           console.error("Error sending PDF:", error);
//           if (onPopupMessage) onPopupMessage("Failed to send email."); // Trigger error popup
//         });
//     });
// }
