...
import InvoicePurCreatepdf from "./invoiceDialog/component/InvoicePurCreatepdf";
import * as XLSX from "xlsx"; // <-- Add this import
import TableViewIcon from "@mui/icons-material/TableView"; // Replace InsertDriveFileIcon import
...
export default function InvoiceTable({
  ...
  const exportToExcel = () => {
    ...
    // Optionally style header row (not all XLSX viewers support this)
