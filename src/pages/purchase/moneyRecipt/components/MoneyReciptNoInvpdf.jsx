...
const moneyReciptNoInvpdf = (data) => {
  ...
  const items = Array.isArray(data.OrderMappingList)
    ? data.OrderMappingList
    : [];
        ...
        <View style={[styles.pageBorder, { marginTop: 0, paddingTop: 0 }]}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.table}>
              ...
              {items.map((item, idx) => (
                <View
                  ...
                  key={idx}
                >
                  <Text style={[styles.tableColFirst, { width: "6%" }]}>
                    {idx + 1}
                  </Text>
                  <Text style={[styles.tableCol, { width: "24%" }]}>
                  ...
                  <Text style={[styles.tableCol, { width: "24%" }]}>
                    {item.ExpectedDeliveryDateTime
                      ? new Date(item.ExpectedDeliveryDateTime).toLocaleString(
                          "en-GB"
                        )
                      : ""}
                  </Text>
            ...
            <Text style={{ marginTop: 8 }}>
              Overall Delivery Date & Time:{" "}
              {data.OverallDeliveryDateTime
          ...
          <View style={styles.section}>
            ...
            <Text>
              In Words:{" "}
              {numberToWordsInIndian(Number(safe(data.ApproxBillAmount)))}
            </Text>
          </View>
...
export default moneyReciptNoInvpdf;

// Usage example (in your parent component):
// import InvoicePDF from './moneyReciptNoInvpdf';
