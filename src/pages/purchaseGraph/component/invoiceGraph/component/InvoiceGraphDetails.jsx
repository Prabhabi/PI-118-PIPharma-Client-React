...
export default function InvoiceGraphDetails({ startingYear, endingYear }) {
  ...
  const fetchYearWiseData = async (year) => {
    const res = await axios.get(
      `${process.env.REACT_APP_URL}/api/getMonthlyEntities?EntityType=SUPP&BillCode=INVP&BillYear=${year}`,
      {
        headers: {
  ...
  const handleNameChange = (event) => {
    ...
    if (selectedData) {
      const invoiceCounts = selectedData.MonthlyData.map((data) => ({
        MonthName: monthAbbreviations[data.MonthName],
          ...
          <Stepper
            ...
            sx={{
              ...
              "& .MuiStepLabel-root .Mui-completed": {
                color: "blue", // color for completed step
              },
              ...
              "& .MuiStepIcon-root": {
                color: "blue !important", // step icon color
              },
              "& .MuiStepIcon-root.Mui-active": {
                color: "blue !important", // active step icon color
              },
              "& .MuiStepIcon-root.Mui-completed": {
                color: "blue !important", // completed step icon color
              },
            }}
          >
            {steps.reverse().map((step, index) => (
              <Step
                ...
                sx={{
                  cursor: "pointer",
                  // Remove previous color overrides for icons
                }}
                completed={false}
